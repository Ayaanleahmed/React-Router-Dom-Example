...
<section class="py-10 bg-gray-50 sm:py-16 lg:py-24">
    <div class="max-w-5xl px-4 mx-auto sm:px-6 lg:px-8">
        <div class="grid items-center grid-cols-1 gap-y-6 md:grid-cols-2 md:gap-x-20">
            <div class="">
                <h2 class="text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl">Welcome CadaaniStock Industry</h2>
                <p class="mt-4 text-base leading-relaxed text-gray-600">Our main Goal is to testify Our Customers </p>
            </div>
