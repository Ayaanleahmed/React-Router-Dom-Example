export default function About() {
    ...
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="max-w-2xl mx-auto text-center">
            <h2 class="text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl">Our Servive</h2>
            <p class="max-w-xl mx-auto mt-4 text-base leading-relaxed text-gray-600">Adeeg Tayeysan iyo Agab Tayeysan</p>
        </div>
