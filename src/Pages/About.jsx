export default function About() {
    ...
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="max-w-2xl mx-auto text-center">
            <h2 class="text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl lg:leading-tight">Waxaad Nagala Soo Xiriiri kartaa Halkan</h2>
            <p class="mt-6 text-lg text-gray-900">Macmiil Fariin Inoo reeb Mahadsanid</p>
